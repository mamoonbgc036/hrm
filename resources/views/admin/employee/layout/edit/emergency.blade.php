...
<form id="contactInfoForm" method="post">
    ...
    <div class="row my-1" id="contact-container">
        @if (!$employee->getContact->isEmpty())
            @foreach ($employee->getContact as $egc)
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label col-form-label-sm"
                                            for="e_contact_person_name">Emergency
                                            Contact Person Name</label>
                                        <input class="form-control" id="e_contact_person_name" type="text"
                                            name="contact[0][e_contact_person_name]"
                                            value="{{ $egc->e_contact_person_name }}">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label col-form-label-sm"
                                            for="e_contact_person_number">Emergency
                                        ...
                                        <input class="form-control" id="e_contact_person_number" type="text"
                                            ...
                                            value="{{ $egc->e_contact_person_number }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="contact[0][e_contact_person_relation]"
                                            id="e_contact_person_relation" class="form-control">
                                            <option value="" disabled selected>SELECT RELATIONSHIP</option>
                                            @foreach ($relationship as $row)
                                                <option value="{{ $row->id }}"
                                                    @if ($egc->e_contact_person_relation == $row->id) selected @endif>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="e_contact_person_name" type="text"
                                            ...
                                            value="{{ $egc->e_contact_person_email }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label col-form-label-sm"
                                            for="e_contact_person_address">Emergency
                                            Contact Person Address</label>
                                        <textarea class="form-control" id="e_contact_person_address" name="contact[0][e_contact_person_address]">{{ $egc->e_contact_person_address }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="e_contact_person_name" type="text"
                                        name="contact[0][e_contact_person_name]"
                                        value="{{ old('e_contact_person_name') }}">
                                    @if (Session::has('employee_id'))
                                        <input type="hidden" name="contact[0][employee_id]"
                                            value="{{ Session::get('employee_id') }}">
                                    @else
