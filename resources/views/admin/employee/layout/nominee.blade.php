...
<form id="nomineeInfoForm" method="post">
    ...
    <div class="mb-1 dom_for_append">
        <div class="mt-2 mb-2 rounded dom_for_clone">
            <div class="row">
                <div class="col-md-11">
                    <div class="wrap-inner border-warning p-3" style="border:1px solid">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <input style="border: unset;" name="picture[]" class="nominee_picture_url" type="file" accept="image/*">
                                    <h6 class="text-danger">Picture size should be 20-200px</span>
                                    <img style="height: 100px;width: 100px; border: 2px solid #adb5bd;border-radius: 3%;"
                                        src="{{ asset('profile_image/dummy.jpg') }}" class="preview_nominee_picture"
                            ...
                            <div class="col-sm-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <input style="border: unset;" name="signature[]" class="nominee_signature_url" type="file"
                                        accept="image/*">
                                    <h6 class="text-danger">Picture size should be 20-200px</h6>
                                    <img style="height: 100px;width: 100px; border: 2px solid #adb5bd;border-radius: 3%;"
                                        src="{{ asset('profile_image/dummy.jpg') }}" class="preview_nominee_signature"
    ...
    <div class="col-sm-12 text-left pl-0">
        <button class="btn btn-info p-2 addMoreNominee"><i class="fa fa-plus-circle"></i>Add More</button>
    </div>
    <div class="row mt-2">
