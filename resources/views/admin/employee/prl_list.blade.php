        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="float-left">
                    <h4><i class="fa fa-list" aria-hidden="true"></i>PRL Employee List</h4>
                </div>
                <div>
                    ...
                    @endcan
                    @can('Employee upcoming prl list')
                        <a href="{{route('employee.upcoming-prl')}}" class="btn btn-warning btn-sm float-right mb-2 ml-1"
                           data-toggle="tooltip" title="Upcoming PRL"><i class="fa fa-plus-square-o" aria-hidden="true"></i>Upcoming PRL</a>
                    @endcan
                </div>
