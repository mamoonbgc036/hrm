@extends('layouts.app')
@section('title','Edit Inhouse Trained Employee')
@push('css')
    <style>
        label{
...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Edit Inhouse Trained Employee </h1>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" value="{{ $inhouse_training->id }}" name="inhouse_training_id">
                        <label class="col-form-label" for="country_id">Country</label>
                        <input class="form-control" id="country_id" name="country_id" readonly value="BANGLADESH">
                ...
                <div class="col-md-4 col-sm-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="venue" name="venue" type="text" placeholder="VENUE" autocomplete="off" value="{{ old('venue',$pivot->venue) }}">
                        @error('venue')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @if($pivot->attachment_file)
                                <a class="form-control" href=" {{route('inhouse_training.attachment.file',$pivot->id)}}">
