@extends('layouts.app')
@section('title','Assign Employee for Inhouse Training')
@section('content')

    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> {{$i_training->course_title}}</h1>
        </div>
        ...
        <div class="col-md-12">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" v-model="form.i_training_id">
            ...
            var vue = new Vue({
                ...
                methods: {
                    ...
                    formSubmit(){
                        ...
                        this.errors = []
                        axios.post('/inhouse-training/store-employee',this.form )
                        .then((response)=>{
                            ...
                            if(response.data === 'done'){
                                ...
                                window.location = "{{route('inhouse-training.index')}}"
                            }
                        })
                        .catch((error)=>{
                ...
                mounted: function (){
                    ...
                    var time = document.querySelectorAll(".demoDate, .demoDate2, .demoDate3");
