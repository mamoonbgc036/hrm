@extends('layouts.app')
@section('title','Assign Employee for Abroad Training')
@section('content')

    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> {{$f_training->course_title}}</h1>
        </div>
        ...
        <div class="col-md-12">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" v-model="form.f_training_id">

                            <div class="col-md-4 col-sm-4 col-sm-6">
                                <div class="form-group">
                                    <label class="col-form-label col-form-label-sm" for="memo_date">Memo Date</label>
                                    <input v-model="form.memo_date" class="form-control demoDate" id="memo_date" name="memo_date" type="text" placeholder="DD-MM-YYYY" autocomplete="off" value="{{old('memo_date')}}">
                            ...
                            <div class="col-md-4 col-sm-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input v-model="form.from_date" @keyup.prevent="getDuration" class="form-control demoDate2" id="from_date" name="from_date" type="text" placeholder="DD-MM-YYYY" autocomplete="off" value="{{old('from_date')}}">
                            ...
                            <div class="col-md-4 col-sm-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input v-model="form.to_date" @keyup.prevent="getDuration" class="form-control demoDate3" id="to_date" name="to_date" type="text" placeholder="DD-MM-YYYY" autocomplete="off" value="{{old('to_date')}}">
                            ...
                            <div class="col-md-4 col-sm-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select v-model="form.country_id" class="form-control text-uppercase" id="country_id" name="country_id">
                        ...
                        <table class="table table-hover table-bordered text-uppercase" id="" style="width:100%;">
                            ...
                            <tbody>
                                <tr v-for="(row, index) in selected_employees_info">
                                    ...
                                    <td><button type="button" @click.prevent="removeId(index)" class="btn btn-sm btn-danger">Remove</button></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            var vue = new Vue({
                ...
                methods: {
                    ...
                    formSubmit(){
                        ...
                        this.errors = []
                        axios.post('/foreign-training/store-employee', this.form)
                        .then((response) => {
                            ...
                            if (response.data === 'done') {
                                ...
                                window.location = "{{route('foreign-training.index')}}"
                            }
                        })
                        .catch((error) => {
                ...
                mounted: function (){
                    ...
                    for (let i = 0; i < time.length; i++) { //Loop trough elements
