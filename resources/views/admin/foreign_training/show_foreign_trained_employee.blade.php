@extends('layouts.app')
@section('title','Show Abroad Trained Employee')
@push('css')
    <style>
        label{
...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Show Abroad Trained Employee </h1>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <select disabled class="form-control text-uppercase" id="country_id" name="country_id">
                ...
                <div class="col-md-4 col-sm-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input disabled class="form-control" id="venue" name="venue" type="text" placeholder="issue authorities" autocomplete="off" value="{{ old('venue',$pivot->venue) }}">
                        @error('venue')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
