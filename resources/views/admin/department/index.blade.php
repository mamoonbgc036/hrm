...
@section('content')
    <div class="app-title">
        <div>
            <h1 class="text"><i class="fa fa-users " aria-hidden="true"></i> Department</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="float-left">
                    <h4 class="text"><i class="fa fa-list " aria-hidden="true"></i> All Department</h4>
                </div>
                <div class="btn-group float-right">
                    ...
                    @endcan
                    @can('Department deleted button')
                        <a href="{{route('department.deleted')}}" class="btn btn-danger btn-sm mb-2"
                           data-toggle="tooltip" title="Deleted List"><i class="fa fa-plus-square-o" aria-hidden="true"></i>Deleted Department</a>
                    @endcan
                </div>
                <div class="tile-body">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                @can('Department delete')
                                                    <form id="trash" method="POST" action="{{ route('department.destroy',$department->id)}}" class="">
                                                        @csrf
                                                        @method('delete')
