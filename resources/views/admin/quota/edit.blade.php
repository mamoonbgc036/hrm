@extends('layouts.app')
@section('title','Edit Quota')
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Quota</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('quota.update',$quota->id)}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-edit fa-lg"></i> Edit quota</h4>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" id="demoSelect" name="status">
                            ...
                            <option value="Active" {{$quota->status=='active' ? 'selected' : ''}}>Active</option>
                            <option value="Inactive" {{$quota->status=='inactive' ? 'selected' : ''}}>Inactive</option>
