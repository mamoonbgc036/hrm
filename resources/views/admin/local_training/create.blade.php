@extends('layouts.app')
@section('title','Create Inland Training')
@section('content')
    ...
    <div class="tile">
        <form action="{{route('local-training.store')}}" method="post">
            @csrf
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Inland Training</h4>
