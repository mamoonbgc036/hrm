@extends('layouts.app')
@section('title','Edit Inland Trained Employee')
@push('css')
    <style>
        label{
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" value="{{ $local_training->id }}" name="local_training_id">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @if($pivot->attachment_file)
                                <a class="form-control" href=" {{route('local_training.attachment.file',$pivot->id)}}">
