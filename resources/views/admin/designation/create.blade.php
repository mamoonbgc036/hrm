...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Create Designation</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('designation.store')}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Designation</h4>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="inputSmall" type="text" name="en_name" value="{{old('en_name')}}">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label class="col-form-label col-form-label-sm" for="inputSmall">বাংলা নাম</label>
                        <input class="form-control" id="inputSmall" type="text" name="bn_name" value="{{old('bn_name')}}">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label class="col-form-label col-form-label-sm" for="inputSmall">Short Name</label>
                        <input class="form-control" id="inputSmall" type="text" name="short_name" value="{{old('short_name')}}">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm demoSelect" id="demoSelect" name="status">
                            <option value="" disabled hidden readonly="" selected>Select Status</option>
