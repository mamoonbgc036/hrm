...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Organization</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('organization.store')}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Organization</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('organization.index')}}"><i class="fa fa-list"></i>See List</a></p>
            </div>
            <div class="row">
