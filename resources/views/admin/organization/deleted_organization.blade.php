...
@section('content')
    <div class="app-title">
        <div>
            <h1 class="text"><i class="fa fa-users " aria-hidden="true"></i> Deleted Organization</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="float-left">
                    <h4 class="text"><i class="fa fa-trash " aria-hidden="true"></i> Deleted Organization</h4>
                </div>
...
{{--                    @can('Organization list')--}}
                        <a href="{{route('organization.index')}}" class="btn btn-info btn-sm mb-2"
                           data-toggle="tooltip" title="Show All"><i class="fa fa-plus-square-o" aria-hidden="true"></i>All Organization</a>
{{--                    @endcan--}}
                </div>
                <div class="tile-body">
                            ...
                            @forelse($organizations as $organization)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
{{--                                            @can('Organization restore')--}}
                                                <a class="btn btn-sm btn-primary" href="{{route('organization.restore', $organization->id)}}"
                                                   data-toggle="tooltip" title="Restore"><i class="fa fa-lg fa-check"></i></a>
{{--                                            @endcan--}}
{{--                                            @can('Organization permanent delete')--}}
                                                <form id="trash" method="POST" action="{{route('organization.permanent-delete',$organization->id)}}" class="">
                                                    @csrf
                                                    @method('delete')
