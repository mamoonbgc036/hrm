@extends('layouts.app')
@section('title','Edit Awarded Employee')
@push('css')
    <style>
        label{
...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Edit Awarded Employee </h1>
        </div>
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-trophy fa-lg"></i>
                    ...
                    <span class="text-primary">
                        {{ \App\Models\Employee::find($pivot->employee_id)->name }}
                    </span>
                </h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('award.show',$award->id)}}"><i class="fa fa-backward"></i>Back To Award</a></p>
            </div>
