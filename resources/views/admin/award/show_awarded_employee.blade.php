@extends('layouts.app')
@section('title','View Awarded Employee')
@push('css')
    <style>
        label{
...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Show Awarded Employee </h1>
        </div>
    ...
    <div class="tile">
        ...
        {{--{{ $pivot->id }}--}}
        <form action="{{route('update-awarded-employee')}}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-trophy fa-lg"></i>
                    <span>
                        <a class="text-success" href="{{route('award.show',$award->id)}}" data-toggle="tooltip" title="Award Show">{{ $award->award_name }}
                        </a>
                    </span>
                    Details for
                    <span>
                ...
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('award.index')}}"><i class="fa fa-backward"></i>Back To Awards</a></p>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @if($pivot->attachment_file)
                                <a class="form-control" href=" {{route('award.attachment.file',$pivot->id)}}">
