...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-eye" aria-hidden="true"></i> View AWARD</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-header bg-info text-white">
                    <span class="card-title">Award Info</span>
                    <a class="btn btn-danger btn-sm icon-btn float-right" href="{{route('award.index')}}"><i class="fa fa-list"></i>See List</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered text-uppercase" id="" style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td>{{$award->created_at ? \Carbon\Carbon::parse($award->created_at)->format('d-m-Y h:i:s A') : ''}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div id="vue_app">
                ...
                <div class="card mb-3">
                    <div class="card-header bg-info text-white">
                        <span class="card-title">Awarded Employee List</span>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#sampleTable2').DataTable({
                serverSide: true,
                processing: true,
                ajax: '{{ route('award.show',$award->id) }}',
                columns:[
                    ...
                    {data:"date_of_award", name:'date_of_award'},
