    ...
    <div class="tile">
        <form action="{{route('upazila.store')}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Upazila</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('upazila.index')}}"><i class="fa fa-list"></i> See List</a></p>
            </div>
            <div class="row">
