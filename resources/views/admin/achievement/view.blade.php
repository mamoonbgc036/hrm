...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-eye" aria-hidden="true"></i> View Achievement</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-header bg-info text-white">
                    <span class="card-title">Achievement Info</span>
                    <a class="btn btn-danger btn-sm icon-btn float-right" href="{{route('achievement.index')}}"><i class="fa fa-list"></i>See List</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered text-uppercase" id="" style="width:100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$achievement->created_at ? \Carbon\Carbon::parse($achievement->created_at)->format('d-m-Y h:i:s A') : ''}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#sampleTable2').DataTable({
                serverSide: true,
                processing: true,
                ajax: '{{ route('achievement.show',$achievement->id) }}',
                columns:[
                    ...
                    {data:"date_of_achievement", name:'date_of_achievement'},
