...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i>Division</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('division.update',$division->id)}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-edit fa-lg"></i>Edit Division</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('division.index')}}"><i class="fa fa-list"></i>See List</a></p>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('bn_name') is-invalid @enderror" id="inputSmall" type="text"
                               name="bn_name" value="{{old('bn_name',$division->bn_name)}}">
                        @error('bn_name')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('url') is-invalid @enderror" id="inputSmall" type="text"
                               name="url" value="{{old('url',$division->url)}}">
                        @error('url')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
