...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Disease</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('disease.update',$disease->id)}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-edit fa-lg"></i> Edit Disease</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('disease.index')}}"><i class="fa fa-list"></i>See List</a></p>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" id="demoSelect" name="status">
                            ...
                            <option value="Inactive" {{$disease->status=='inactive' ? 'selected' : ''}}>Inactive</option>
