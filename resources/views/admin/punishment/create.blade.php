...
@section('content')
  ...
  <div class="tile">
        <form action="{{route('punishment.store')}}" method="post">
            @csrf
            <div class="tile-title-w-btn"><h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Punishment</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('punishment.index')}}"><i
