@extends('layouts.app')
@section('title','Edit Punished Employee')
@push('css')
    <style>
        label{
...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Edit Punished Employee </h1>
        </div>
    ...
    <div class="tile">
        ...
        <form action="{{route('update-punishment-employee')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="complaint_description" type="text" name="complaint_description" placeholder="Complaint Description" value="{{ old('complaint_description',$pivot->complaint_description) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile1" value="{{ old('complaint_file',$pivot->complaint_file) }}" name="complaint_file"/>
                                </label>
                        ...
                        <label id="showFileName1" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="departmental_case_memo_no_date_and_section" type="text" name="departmental_case_memo_no_date_and_section" placeholder="Departmental Case Memo No, Date & Section" value="{{ old('departmental_case_memo_no_date_and_section',$pivot->departmental_case_memo_no_date_and_section) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile2" value="{{ old('departmental_case_file',$pivot->departmental_case_file) }}" name="departmental_case_file"/>
                                </label>
                        ...
                        <label id="showFileName2" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile3" value="{{ old('settlement_punishment_file',$pivot->settlement_punishment_file) }}" name="settlement_punishment_file"/>
                                </label>
                        ...
                        <label id="showFileName3" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile4" value="{{ old('appeal_and_disposal_file',$pivot->appeal_and_disposal_file) }}" name="appeal_and_disposal_file"/>
                                </label>
                        ...
                        <label id="showFileName4" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile5" value="{{ old('case_no_and_judgment_file',$pivot->case_no_and_judgment_file) }}" name="case_no_and_judgment_file"/>
                                </label>
                        ...
                        <label id="showFileName5" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile6" value="{{ old('case_no_administrative_file',$pivot->case_no_administrative_file) }}" name="case_no_administrative_file"/>
                                </label>
                        ...
                        <label id="showFileName6" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="leave_to_memo_no_and_judgement" type="text" name="leave_to_memo_no_and_judgement" placeholder="Leave to Memo No.and Judgement" value="{{ old('leave_to_memo_no_and_judgement',$pivot->leave_to_memo_no_and_judgement) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile7" value="{{ old('leave_to_memo_file',$pivot->leave_to_memo_file) }}" name="leave_to_memo_file"/>
                                </label>
                        ...
                        <label id="showFileName7" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="review_case_no_and_judgement" type="text" name="review_case_no_and_judgement" placeholder="Review Case No. and Judgment" value="{{ old('review_case_no_and_judgement',$pivot->review_case_no_and_judgement) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile8" value="{{ old('review_case_no_file',$pivot->review_case_no_file) }}" name="review_case_no_file"/>
                                </label>
                        ...
                        <label id="showFileName8" class="col-form-label"></label>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="punishment_notice" type="text" name="punishment_notice" placeholder="Punishment Notice" value="{{ old('punishment_notice',$pivot->punishment_notice) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile9" value="{{ old('punishment_notice_file',$pivot->punishment_notice_file) }}" name="punishment_notice_file"/>
                                </label>
                        ...
                        <label id="showFileName9" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="accused_reply" type="text" name="accused_reply" placeholder="Accused Reply" value="{{ old('accused_reply',$pivot->accused_reply) }}">
                                @error('accused_reply')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile10" value="{{ old('accused_reply_file',$pivot->accused_reply_file) }}" name="accused_reply_file"/>
                                </label>
                        ...
                        <label id="showFileName10" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="action_apply" type="text" name="action_apply" placeholder="Action" value="{{ old('action_apply',$pivot->action_apply) }}">
                                @error('action_apply')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile11" value="{{ old('action_apply_file',$pivot->action_apply_file) }}" name="action_apply_file"/>
                                </label>
                        ...
                        <label id="showFileName11" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="disposal_verdict" type="text" name="disposal_verdict" placeholder="Disposal Verdict" value="{{ old('disposal_verdict',$pivot->disposal_verdict) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile12" value="{{ old('disposal_verdict_file',$pivot->disposal_verdict_file) }}" name="disposal_verdict_file"/>
                                </label>
                        ...
                        <label id="showFileName12" class="col-form-label"></label>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="additional_notes" type="text" name="additional_notes" placeholder="Additional Notes" value="{{ old('additional_notes',$pivot->additional_notes) }}">
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile13" value="{{ old('additional_notes_file',$pivot->additional_notes_file) }}" name="additional_notes_file"/>
                                </label>
                        ...
                        <label id="showFileName13" class="col-form-label"></label>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-sm-6 border">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <input class="form-control" id="comments" type="text" name="comments" placeholder="Comments" value="{{ old('comments',$pivot->comments) }}">
                                @error('comments')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4">
                                <label class="custom-file-upload btn btn-info mb-0">
                                    <i class="fa fa-cloud-upload"></i>
                                    <input type="file" id="hasFile14" value="{{ old('comments_file',$pivot->comments_file) }}" name="comments_file"/>
                                </label>
                        ...
                        <label id="showFileName14" class="col-form-label"></label>
                    </div>
                </div>
...
@section('js')
    <script>
        //show file name
        $('#hasFile1').change(function() {$('#showFileName1').html('<b>File Name : </b>'+ $('#hasFile1').val().split('\\').pop()); })
        $('#hasFile2').change(function() {$('#showFileName2').html('<b>File Name : </b>'+ $('#hasFile2').val().split('\\').pop()); })
        $('#hasFile3').change(function() {$('#showFileName3').html('<b>File Name : </b>'+ $('#hasFile3').val().split('\\').pop()); })
        $('#hasFile4').change(function() {$('#showFileName4').html('<b>File Name : </b>'+ $('#hasFile4').val().split('\\').pop()); })
        $('#hasFile5').change(function() {$('#showFileName5').html('<b>File Name : </b>'+ $('#hasFile5').val().split('\\').pop()); })
        $('#hasFile6').change(function() {$('#showFileName6').html('<b>File Name : </b>'+ $('#hasFile6').val().split('\\').pop()); })
        $('#hasFile7').change(function() {$('#showFileName7').html('<b>File Name : </b>'+ $('#hasFile7').val().split('\\').pop()); })
        $('#hasFile8').change(function() {$('#showFileName8').html('<b>File Name : </b>'+ $('#hasFile8').val().split('\\').pop()); })
        $('#hasFile9').change(function() {$('#showFileName9').html('<b>File Name : </b>'+ $('#hasFile9').val().split('\\').pop()); })
        $('#hasFile10').change(function() {$('#showFileName10').html('<b>File Name : </b>'+ $('#hasFile10').val().split('\\').pop()); })
        $('#hasFile11').change(function() {$('#showFileName11').html('<b>File Name : </b>'+ $('#hasFile11').val().split('\\').pop()); })
        $('#hasFile12').change(function() {$('#showFileName12').html('<b>File Name : </b>'+ $('#hasFile12').val().split('\\').pop()); })
        $('#hasFile13').change(function() {$('#showFileName13').html('<b>File Name : </b>'+ $('#hasFile13').val().split('\\').pop()); })
        $('#hasFile14').change(function() {$('#showFileName14').html('<b>File Name : </b>'+ $('#hasFile14').val().split('\\').pop()); })
