...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-users" aria-hidden="true"></i> Location</h1>
        </div>
    ...
    <div class="tile">
        <form action="{{route('location.store')}}" method="post">
            ...
            <div class="tile-title-w-btn">
                <h4 class="title"><i class="fa fa-plus fa-lg"></i> Create Location</h4>
                <p><a class="btn btn-primary btn-sm icon-btn" href="{{route('location.index')}}"><i class="fa fa-list"></i>See List</a></p>
            </div>
            <div class="row">
