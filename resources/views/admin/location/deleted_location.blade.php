@extends('layouts.app')
@section('title','Deleted Locations')
@section('content')
    <div class="app-title">
        <div>
            <h1 class="text"><i class="fa fa-users " aria-hidden="true"></i> Deleted Location</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="float-left">
                    <h4 class="text"><i class="fa fa-trash " aria-hidden="true"></i> Deleted Location</h4>
                </div>
...
{{--                    @endcan--}}
{{--                    @can('Location list')--}}
                        <a href="{{route('location.index')}}" class="btn btn-info btn-sm mb-2"
                           data-toggle="tooltip" title="Show All"><i class="fa fa-plus-square-o" aria-hidden="true"></i>All Location</a>
{{--                    @endcan--}}
                </div>
                <div class="tile-body">
...
{{--                                            @can('Location restore')--}}
                                                <a class="btn btn-sm btn-primary" href="{{route('location.restore', $location->id)}}"
                                                   data-toggle="tooltip" title="Restore"><i class="fa fa-lg fa-check"></i></a>
{{--                                            @endcan--}}
{{--                                            @can('Location permanent delete')--}}
                                                <form id="trash" method="POST" action="{{route('location.permanent-delete',$location->id)}}" class="">
                                                    @csrf
                                                    @method('delete')
